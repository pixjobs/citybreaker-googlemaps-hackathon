...
export default function HomePage() {
  ...
  const handleMenuAction = useCallback((action: string) => {
    switch (action) {
      case "toggle-satellite": setIsSatelliteView(prev => !prev); break;
      case "toggle-landmarks": setShowLandmarks(prev => !prev); break;
      case "toggle-restaurants": setShowRestaurants(prev => !prev); break;
