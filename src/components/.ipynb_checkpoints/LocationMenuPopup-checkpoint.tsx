...
import Image from "next/image"; // Kept for YouTube thumbnails
...
// ✅ THE DEFINITIVE FIX: This interface is updated to match the modern API.
// It now uses `editorialSummary` (camelCase) instead of the old `editorial_summary`.
export interface RichPlaceDetails {
  website?: string;
  rating?: number;
  reviews?: Review[];
  editorialSummary?: { overview?: string }; // Corrected property name
}
